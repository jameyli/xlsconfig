...
def GetField(sheet, col) :
    ...
    #      field.default_value = GetDefaultValue(field.typename)

    field.comment = unicode(sheet.cell_value(FIELD_COMMENT_ROW, col)).encode("utf-8")
    #  field.value_str = self._sheet.cell_value(self._row, col)
...
class SheetInterpreter:
    ...
    def _LayoutFileHeader(self) :
        ...
        self._output.append("* @note: Generated by the xls config tool.  DO NOT EDIT!\n")
        self._output.append("* @source: xls ("+ self._xls_file_path+") sheet ("+ self._sheet_name + ")\n")
        self._output.append("* @author: jameyli <github.com/jameyli>\n")
        self._output.append("**/\n\n")
...
class LuaParser:
    ...
    def Parse(self) :
        self.all_str = "-- Generated by the xls config tool.  DO NOT EDIT!\n"
